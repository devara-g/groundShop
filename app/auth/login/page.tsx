      ...
      <div className="w-full max-w-5xl bg-white rounded-3xl shadow-2xl flex flex-col md:flex-row overflow-hidden relative z-10 min-h-[600px]">
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col justify-center">
          <div className="text-center mb-10">
            <h1 className="text-4xl font-extrabold text-[#0a84c6] tracking-tight">Welcome</h1>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-6 max-w-sm mx-auto w-full">
            ...
            <div>
              ...
              <div className="flex justify-end mt-1">
                 <span className="text-[11px] text-slate-400 cursor-pointer hover:text-[#0a84c6]">Forgot password?</span>
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full bg-[#189cd8] text-white py-3 rounded-lg font-bold hover:bg-[#0a84c6] disabled:opacity-50 transition-all shadow-md shadow-blue-500/20"
            >
          ...
          <div className="my-8 flex items-center max-w-sm mx-auto w-full before:flex-1 before:border-t before:border-slate-100 after:flex-1 after:border-t after:border-slate-100">
            <p className="mx-4 text-xs font-medium text-slate-400 uppercase tracking-wider">
              OR
            </p>
          </div>

          <div className="max-w-sm mx-auto w-full flex justify-center gap-4 mb-8">
            <button
              onClick={async () => {
                setLoading(true)
          ...
          <p className="text-center text-sm font-medium text-slate-500">
            ...
            <Link href="/auth/register" className="text-[#189cd8] font-bold hover:underline transition-colors">
              Sign Up
            </Link>
          </p>
        </div>
